...
| 단계 | 산출물 | 완료 조건 | 의존 |
| --- | --- | --- | --- |
| M0 대상 확정 | 첫 route 계약, 부작용·데이터·권한 목록, 운영 수치 | 해당 단계의 필수 미정 항목과 검증 방법 확보 | 사용자·서비스 환경 입력 |
...
| M7 확장·종료 | 두 번째 API 또는 최종 종료 기록 | core에 불필요한 업무 로직 추가 없이 적용, 잔존 의존 정리 | 실제 필요와 M6 결과 |
